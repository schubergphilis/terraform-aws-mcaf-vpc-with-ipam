...
| <a name="input_route53_profiles_association"></a> [route53\_profiles\_association](#input\_route53\_profiles\_association) | Variable to enable Route53 Profiles association. Lookup 'profile\_names' of Route53 Profiles in the account to associate with the VPC. | <pre>object({<br/>    enabled                 = optional(bool, false)<br/>    association_name_prefix = optional(string, "")<br/>    profile_names           = optional(set(string), [])<br/>  })</pre> | `{}` | no |
