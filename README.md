...
| <a name="input_route53_profiles_association"></a> [route53\_profiles\_association](#input\_route53\_profiles\_association) | Variable to enable Route53 Profiles association. Lookup 'names' of Route53 Profiles in the account to associate with the VPC. If 'names' are not specified, then all Route53 Profiles in the account will be associated to the VPC. | <pre>object({<br/>    enabled = optional(bool, false)<br/>    names   = optional(set(string), [])<br/>  })</pre> | `{}` | no |
