...
| <a name="input_route53_profile_id"></a> [route53\_profile\_id](#input\_route53\_profile\_id) | The Route53 profile ID to use for managing centralized Interface endpoints | `string` | `null` | no |
